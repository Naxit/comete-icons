...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      ...
      "none": { viewBox: "0 0 16 18", paths: <><path fill="#8270DB" fillRule="evenodd" d="M5.34 1.357a1.982 1.982 0 1 0 0 3.965h1.982V1.357zM8 0h2.66a3.34 3.34 0 0 1 2.019 6 3.34 3.34 0 0 1-4 5.348v2.634a3.34 3.34 0 1 1-5.358-2.66A3.33 3.33 0 0 1 2 8.66C2 7.575 2.518 6.61 3.321 6A3.34 3.34 0 0 1 5.34 0zM5.34 6.679a1.982 1.982 0 1 0 0 3.964h1.982V6.68zm3.338-1.357h1.983a1.982 1.982 0 0 0 0-3.965H8.678zm1.983 1.356a1.982 1.982 0 1 0 0 3.965 1.982 1.982 0 0 0 0-3.965M7.32 12H5.34a1.982 1.982 0 1 0 1.983 1.982z" clipRule="evenodd"/></> }
    }
};

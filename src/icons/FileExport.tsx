...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M4.603 2.586q-.586.586-.586 1.41v15.96q0 .825.586 1.41.587.587 1.41.587l5.242.002v-1.996l-5.242-.002V3.996h6.985v4.99h4.99v3.834h1.995V7.987L13.996 2H6.013q-.824 0-1.41.586" clipRule="evenodd"/><path fill="#0076D8" d="m14.338 22-1.397-1.422 2.944-2.944H13.64V15.64h5.637v5.637h-1.995v-2.22z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="M2.059.459A1.5 1.5 0 0 0 1.6 1.56v12.49q0 .644.459 1.103.458.458 1.103.458l4.1.002v-1.561l-4.1-.002V1.561h5.464v3.904h3.904v3h1.562v-3.78L9.407 0H3.162q-.645 0-1.103.459" clipRule="evenodd"/><path fill="#0076D8" d="m9.675 15.648-1.093-1.113 2.303-2.303H9.128v-1.561h4.411v4.41h-1.561v-1.736z"/></> }
    }
};

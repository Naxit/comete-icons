...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="var(--icon-information)" d="M3.75 21V3h9.9l.44 2.118h6.16v10.588h-7.7l-.44-2.118H5.95V21zm10.615-7.412h3.685V7.235h-5.775l-.44-2.117H5.95v6.353h7.975z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="var(--icon-information)" d="M.7 16V0h8.8l.391 1.882h5.476v9.412H8.522l-.39-1.882H2.655V16zm9.436-6.588h3.275V3.765H8.278l-.391-1.883H2.656V7.53h7.089z"/></> }
    }
};

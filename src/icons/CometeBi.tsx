...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M8.833 17.814 2 2l15.706 6.493c2.56 1.053 4.248 3.575 4.293 6.39.058 3.867-2.975 7.059-6.769 7.117h-.108c-2.72 0-5.189-1.638-6.29-4.186" clipRule="evenodd"/><path fill="currentColor" fillRule="evenodd" d="M13.094 20.417a6.1 6.1 0 0 1-2.5-1.646v-2.823a.36.36 0 0 1 .358-.322h1.784a.354.354 0 0 1 .358.322zm3.51-7.853a.37.37 0 0 0-.143-.192.36.36 0 0 0-.202-.06h-1.781a.36.36 0 0 0-.359.324v7.886a.3.3 0 0 0 .006.08v.007q.001.014.007.026l.003.007.015.036q.461.071.927.072h.095a6 6 0 0 0 1.443-.196v-7.882a.3.3 0 0 0-.012-.108m3.54 1.65v3.823a6.14 6.14 0 0 1-2.5 2.149v-5.972a.36.36 0 0 1 .252-.344.4.4 0 0 1 .107-.014h1.819a.37.37 0 0 1 .262.157c.04.06.06.13.06.2" clipRule="evenodd"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="M5.466 12.651 0 0l12.565 5.195c2.047.842 3.399 2.86 3.434 5.111.046 3.094-2.38 5.647-5.415 5.694h-.087c-2.175 0-4.15-1.31-5.03-3.349" clipRule="evenodd"/><path fill="currentColor" fillRule="evenodd" d="M8.875 14.734a4.9 4.9 0 0 1-2-1.317v-2.259a.3.3 0 0 1 .126-.21.3.3 0 0 1 .16-.047H8.59q.088 0 .16.048a.3.3 0 0 1 .126.21zm2.808-6.282a.3.3 0 0 0-.114-.153.3.3 0 0 0-.162-.049H9.982a.29.29 0 0 0-.286.259v6.308a.2.2 0 0 0 .004.065v.005q0 .01.006.021l.002.006.012.028q.368.058.742.058h.076q.587-.009 1.154-.157V8.537a.3.3 0 0 0-.01-.085m2.833 1.319v3.058a4.9 4.9 0 0 1-2 1.72V9.77a.29.29 0 0 1 .257-.286h1.485a.3.3 0 0 1 .21.126.3.3 0 0 1 .048.16" clipRule="evenodd"/></> }
    }
};

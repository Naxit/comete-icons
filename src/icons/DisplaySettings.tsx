...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M8 21v-2H4q-.824 0-1.412-.587A1.93 1.93 0 0 1 2 17V5q0-.824.587-1.412A1.93 1.93 0 0 1 4 3h16q.824 0 1.413.587Q22 4.176 22 5v12q0 .824-.587 1.413A1.93 1.93 0 0 1 20 19h-4v2zm-4-4h16V5H4z" clipRule="evenodd"/><path fill="#007ADA" d="M10 13.75h8v-1.5h-8zM7.5 15H9v-4H7.5v1.25H6v1.5h1.5zM6 9.75h8v-1.5H6zM15 11h1.5V9.75H18v-1.5h-1.5V7H15z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="#007ADA" fillRule="evenodd" d="M5.6 10.4H4.4v-1H3.2V8.2h1.2v-1h1.2zm7.2-2.2v1.2H6.4V8.2zm-1.2-1h-1.2V4h1.2v1h1.2v1.2h-1.2zm-2-1H3.2V5h6.4z" clipRule="evenodd"/><path fill="currentColor" fillRule="evenodd" d="M4.8 15.2v-1.6H1.6a1.54 1.54 0 0 1-1.13-.47A1.54 1.54 0 0 1 0 12V2.4q0-.66.47-1.13A1.54 1.54 0 0 1 1.6.8h12.8q.66 0 1.13.47T16 2.4V12q0 .66-.47 1.13a1.54 1.54 0 0 1-1.13.47h-3.2v1.6zm9.6-3.2H1.6V2.4h12.8z" clipRule="evenodd"/></> }
    }
};

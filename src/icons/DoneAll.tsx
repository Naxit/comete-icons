...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="#009B60" d="m6.7 18-5.65-5.65 1.425-1.4 4.25 4.25 1.4 1.4zm5.65 0L6.7 12.35l1.4-1.425 4.25 4.25 9.2-9.2 1.4 1.425zm0-5.65-1.425-1.4L15.875 6 17.3 7.4z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="#009B60" d="M4.128 12.393 0 8.265l1.041-1.023 3.105 3.105L5.17 11.37zm4.128 0L4.128 8.265 5.15 7.224l3.105 3.105 6.721-6.722L16 4.65zm0-4.128L7.215 7.242l3.616-3.616 1.041 1.023z"/></> }
    }
};

...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      ...
      "none": { viewBox: "0 0 16 16", paths: <><g fill="currentColor" clip-path="url(#clip0_795_3548)"><path fillRule="evenodd" d="M0 2v3h2V2h12v3h2V2q0-.824-.588-1.412A1.93 1.93 0 0 0 14 0H2Q1.176 0 .588.588A1.93 1.93 0 0 0 0 2" clipRule="evenodd"/><path d="M7 16V7.85l-2.6 2.6L3 9l5-5 5 5-1.4 1.45L9 7.85V16z"/></g><defs><clipPath id="clip0_795_3548"><path fill="currentColor" d="M0 0h16v16H0z"/></clipPath></defs></> }
    }
};

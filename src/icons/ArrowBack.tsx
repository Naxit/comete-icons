...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      ...
      "none": { viewBox: "0 0 16 16", paths: <><g clip-path="url(#clip0_620_3363)"><path fill="var(--icon-information)" d="m3.825 9 5.6 5.6L8 16 0 8l8-8 1.425 1.4-5.6 5.6H16v2z"/></g><defs><clipPath id="clip0_620_3363"><path fill="#fff" d="M0 0h16v16H0z"/></clipPath></defs></> }
    }
};

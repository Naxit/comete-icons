...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="var(--icon-warning)" fillRule="evenodd" d="M18 10.5H6V9h12zm0 4.5H6v-1.5h12z" clipRule="evenodd"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="var(--icon-warning)" fillRule="evenodd" d="M14 6.5H2V5h12zm0 4.5H2V9.5h12z" clipRule="evenodd"/></> }
    }
};

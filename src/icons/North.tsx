...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="#0076D8" d="M11 22V5.825L6.4 10.4 5 9l7-7 7 7-1.4 1.425-4.6-4.6V22z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="#0076D8" d="M7.2 16V3.06L3.52 6.72 2.4 5.6 8 0l5.6 5.6-1.12 1.14L8.8 3.06V16z"/></> }
    }
};

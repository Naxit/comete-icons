...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" d="M3.5 15h1.25v-3.5L7.3 15h1.2V9H7.25v3.5L4.75 9H3.5zm6 0h4v-1.25H11v-1.1h2.5V11.4H11v-1.15h2.5V9h-4z"/><path fill="currentColor" fillRule="evenodd" d="M1.588 19.413Q2.175 20 3 20h18q.824 0 1.413-.587Q23 18.825 23 18V6q0-.824-.587-1.412A1.93 1.93 0 0 0 21 4H3q-.824 0-1.412.588A1.93 1.93 0 0 0 1 6v12q0 .824.587 1.413M21 18H3V6h18z" clipRule="evenodd"/><path fill="currentColor" d="M15.5 15h4q.424 0 .712-.287A.97.97 0 0 0 20.5 14V9h-1.25v4.5h-1.1V10H16.9v3.5h-1.15V9H14.5v5q0 .424.287.713.288.287.713.287"/></> },

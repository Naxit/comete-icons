...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="#0076D8" d="M5 19v-2.5h4l3-9H8V5h10v2.5h-3.5l-3 9H15V19z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="#0076D8" d="M1.5 15v-2.5h4l3-9h-4V1h10v2.5H11l-3 9h3.5V15z"/></> }
    }
};

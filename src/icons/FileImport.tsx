...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M12.017 20v2h6q.824 0 1.413-.587.587-.588.587-1.413V8l-6-6h-8q-.824 0-1.412.587A1.93 1.93 0 0 0 4.017 4v10h2V4h7v5h5v11z" clipRule="evenodd"/><path fill="var(--icon-information)" d="m10.215 16.876-1.33-1.354-2.804 2.804V16.21H4.18v5.37h5.37v-1.9H7.41z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="M8.697 13.916v1.547h4.639q.638 0 1.092-.455.454-.453.454-1.092V4.64L10.243 0H4.058q-.637 0-1.092.454a1.5 1.5 0 0 0-.454 1.092v7.732h1.546V1.546H9.47v3.866h3.866v8.504z" clipRule="evenodd"/><path fill="var(--icon-information)" d="m6.558 11.901-1.064-1.083L3.25 13.06v-1.69H1.73v4.295h4.295v-1.52h-1.71z"/></> }
    }
};

...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M20 18H4V6h5.175l2 2H20zM2.588 19.413Q3.174 20 4 20h16q.824 0 1.413-.587Q22 18.825 22 18V8q0-.824-.587-1.412A1.93 1.93 0 0 0 20 6h-8l-2-2H4q-.824 0-1.412.588A1.93 1.93 0 0 0 2 6v12q0 .824.587 1.413" clipRule="evenodd"/><path fill="var(--icon-information)" d="M14 16v2h2v-2zm2-2v2h2v-2zm-2 0h2v-2h-2zm2-4v2h2v-2zm0 0V8h-2v2z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="M14.4 12.8H1.6V3.2h4.14l1.6 1.6h7.06zM.47 13.93q.47.47 1.13.47h12.8q.66 0 1.13-.47T16 12.8v-8q0-.66-.47-1.13a1.54 1.54 0 0 0-1.13-.47H8L6.4 1.6H1.6q-.66 0-1.13.47A1.54 1.54 0 0 0 0 3.2v9.6q0 .66.47 1.13" clipRule="evenodd"/><path fill="var(--icon-information)" d="M9.6 11.2v1.6h1.6v-1.6zm1.6-1.6v1.6h1.6V9.6zm-1.6 0h1.6V8H9.6zm1.6-3.2V8h1.6V6.4zm0 0V4.8H9.6v1.6z"/></> }
    }
};

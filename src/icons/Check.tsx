...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    outlined: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" d="m9.55 18-5.7-5.7 1.425-1.425L9.55 15.15l9.175-9.175L20.15 7.4z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" d="M5.896 13.164 1 8.268l1.224-1.223 3.672 3.671 7.88-7.88L15 4.06z"/></> }
    },
    filled: {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="#009B60" d="m9.55 18-5.7-5.7 1.425-1.425L9.55 15.15l9.175-9.175L20.15 7.4z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="#009B60" d="M5.896 13.164 1 8.268l1.224-1.223 3.672 3.671 7.88-7.88L15 4.06z"/></> }
    }
};

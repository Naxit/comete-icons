...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" d="M14.384 11.799a.96.96 0 0 0-.697-.273H9.775q-.416 0-.697.273a.9.9 0 0 0-.28.675q0 .402.28.675.282.272.697.272h3.058a5.8 5.8 0 0 1 1.655-1.504 1 1 0 0 0-.104-.118"/><path fill="currentColor" d="M3.907 20.052V7.832L2 3.805 3.76 3l2.3 4.784h11.345L19.702 3l1.76.805-1.907 4.027v3.545a6 6 0 0 0-1.956-.324V9.68H5.863v8.479h6.053c.184.69.498 1.331.916 1.894z"/><path fill="#009B60" fillRule="evenodd" d="M22 16.737C22 19.09 20.03 21 17.599 21s-4.401-1.909-4.401-4.263 1.97-4.263 4.401-4.263S22 14.383 22 16.737m-1.194-1.114-3.78 3.557-2.374-2.235.953-.898 1.405 1.323 2.826-2.66z" clipRule="evenodd"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" d="M9.907 7.834a.76.76 0 0 0-.557-.225H6.22a.76.76 0 0 0-.557.225.76.76 0 0 0-.225.557q0 .333.225.557.224.225.557.225h2.447A4.7 4.7 0 0 1 9.99 7.931a1 1 0 0 0-.084-.097"/><path fill="currentColor" d="M1.526 14.65V4.557L0 1.232 1.408.567l1.839 3.951h9.076L14.16.567l1.409.665-1.526 3.325v2.928a4.7 4.7 0 0 0-1.564-.267V6.083H3.09v7.002h4.843c.147.571.398 1.1.733 1.565z"/><path fill="#009B60" fillRule="evenodd" d="M16 11.912a3.52 3.52 0 1 1-7.042 0 3.52 3.52 0 0 1 7.042 0m-.955-.92L12.02 13.93l-1.9-1.846.763-.741 1.124 1.092 2.261-2.197z" clipRule="evenodd"/></> }
    }
};

...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M4 12.333v2h7.714v-2zm0-4.166v2h11.571v-2zM4 4v2h11.571V4z" clipRule="evenodd"/><path fill="#007ADA" fillRule="evenodd" d="M13 20v-3.139l5.625-5.805q.195-.207.432-.298.238-.09.472-.091a1.27 1.27 0 0 1 .917.389l1.179 1.25q.177.2.276.448.099.246.099.49 0 .243-.088.497a1.2 1.2 0 0 1-.287.453L16.027 20zm6.509-8 1.205 1.25-5.223 5.417h-1.205v-1.25z" clipRule="evenodd"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="M0 8.244v1.667h6.857V8.244zm0-3.472v1.667h10.286V4.772zM0 1.3v1.666h10.286V1.3z" clipRule="evenodd"/><path fill="#007ADA" fillRule="evenodd" d="M8 14.633v-2.616l5-4.838a1.05 1.05 0 0 1 .384-.247q.21-.077.42-.077.227 0 .436.081.208.081.379.243l1.048 1.042q.156.168.245.373.088.205.088.409 0 .202-.078.414a1 1 0 0 1-.255.378l-4.976 4.838zm5.786-6.667 1.071 1.042-4.643 4.514H9.143V12.48z" clipRule="evenodd"/></> }
    }
};

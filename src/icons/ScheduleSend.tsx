...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M2.98 4.444v15.233l7.295-3.079v-.016q.032-.412.15-.948.12-.535.31-.987l-6.172 2.602v-3.761l5.728-1.428-5.728-1.46V6.825l10.111 4.284a6 6 0 0 1 1.068-.238 9 9 0 0 1 1.242-.08h1.03z" clipRule="evenodd"/><path fill="currentColor" fillRule="evenodd" d="M16.43 21.58q-1.89 0-3.24-1.344-1.348-1.345-1.348-3.241 0-1.912 1.349-3.265 1.35-1.353 3.24-1.353t3.24 1.353q1.348 1.353 1.348 3.265 0 1.896-1.348 3.24-1.35 1.346-3.24 1.346m2.31-2.92-.68.715-2.167-2.174v-3.22h.965v2.792z" clipRule="evenodd"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="M0 1.25v12l6.47-2.425v-.012q.028-.325.134-.747.105-.422.273-.778l-5.473 2.05V8.375l5.08-1.125-5.08-1.15V3.125L10.372 6.5q.428-.125.947-.187a9 9 0 0 1 1.102-.063h.913z" clipRule="evenodd"/><path fill="currentColor" fillRule="evenodd" d="M11.93 14.75q-1.677 0-2.874-1.06-1.197-1.059-1.196-2.553 0-1.505 1.196-2.571Q10.253 7.5 11.93 7.5t2.874 1.066Q16 9.63 16 11.137q0 1.494-1.196 2.554-1.197 1.059-2.874 1.059m2.049-2.3-.604.562-1.922-1.712V8.763h.856v2.2z" clipRule="evenodd"/></> }
    }
};

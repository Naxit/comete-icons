...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M5.261 20.557a1.75 1.75 0 0 0 1.284.534h10.91q.75 0 1.284-.534a1.75 1.75 0 0 0 .534-1.284v-2.727h-1.819v2.727H6.545v-2.727H4.727v2.727q0 .75.534 1.284m-.534-15.83v6.364h1.818V4.727h6.364v4.546h4.545v1.818h1.819V8.364l-5.455-5.455H6.545q-.75 0-1.284.534a1.75 1.75 0 0 0-.534 1.284" clipRule="evenodd"/><path fill="#0076D8" d="M9.273 14.727V12.91h5.454v1.818zm7.273 0V12.91H22v1.818zM2 14.727V12.91h5.455v1.818z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="M2.61 14.918a1.4 1.4 0 0 0 1.026.427h8.728a1.4 1.4 0 0 0 1.027-.427 1.4 1.4 0 0 0 .427-1.027v-2.182h-1.454v2.182H3.636v-2.182H2.182v2.182q0 .6.427 1.027M2.181 2.254v5.091h1.454v-5.09h5.091V5.89h3.637v1.454h1.454V5.163L9.455.8H3.636a1.4 1.4 0 0 0-1.027.427 1.4 1.4 0 0 0-.427 1.027" clipRule="evenodd"/><path fill="#0076D8" d="M5.818 10.254V8.8h4.364v1.454zm5.818 0V8.8H16v1.454zM0 10.254V8.8h4.364v1.454z"/></> }
    }
};

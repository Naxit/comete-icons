...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="#6F8488" d="M8.4 17 7 15.6l3.6-3.6L7 8.425l1.4-1.4 3.6 3.6 3.575-3.6 1.4 1.4-3.6 3.575 3.6 3.6-1.4 1.4L12 13.4z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="#6F8488" d="m4.4 12.975-1.4-1.4 3.6-3.6L3 4.4 4.4 3 8 6.6 11.575 3l1.4 1.4-3.6 3.575 3.6 3.6-1.4 1.4L8 9.375z"/></> }
    }
};

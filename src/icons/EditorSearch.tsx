...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="#007ADA" d="M14.4 15.473a5.5 5.5 0 1 1 1.06-1.06l2.647 2.647c.293.293.53.59 0 1.06s-.767.293-1.06 0zm-3.323-.383a4 4 0 1 0 0-8 4 4 0 0 0 0 8"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="#007ADA" d="M10.4 11.473a5.5 5.5 0 1 1 1.06-1.06l2.647 2.647c.293.293.53.59 0 1.06s-.767.293-1.06 0zm-3.323-.383a4 4 0 1 0 0-8 4 4 0 0 0 0 8"/></> }
    }
};

...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="#007ADA" d="M3 18v-2h12v2zm0-5v-2h18v2zm0-5V6h18v2z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="#007ADA" d="M2 12v-1.333h8V12zm0-3.333V7.333h12v1.334zm0-3.334V4h12v1.333z"/></> }
    }
};

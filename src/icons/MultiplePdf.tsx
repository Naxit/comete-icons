...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="#0076D8" fillRule="evenodd" d="M9 12.5h1v-2h1q.424 0 .713-.287A.97.97 0 0 0 12 9.5v-1a.97.97 0 0 0-.287-.713A.97.97 0 0 0 11 7.5H9zm1-4v1h1v-1zm3 4h2q.424 0 .713-.287A.97.97 0 0 0 16 11.5v-3a.97.97 0 0 0-.287-.713A.97.97 0 0 0 15 7.5h-2zm1-4v3h1v-3z" clipRule="evenodd"/><path fill="currentColor" fillRule="evenodd" d="M6.588 17.413Q7.175 18 8 18h12q.824 0 1.413-.587Q22 16.825 22 16V4q0-.824-.587-1.412A1.93 1.93 0 0 0 20 2H8q-.824 0-1.412.587A1.93 1.93 0 0 0 6 4v12q0 .824.588 1.413M20 16H8V4h12zM2.588 21.413Q3.174 22 4 22h14v-2H4V6H2v14q0 .824.587 1.413" clipRule="evenodd"/><path fill="#0076D8" d="M17 12.5h1v-2h1v-1h-1v-1h1v-1h-2z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="#0076D8" fillRule="evenodd" d="M5.6 8.4h.8V6.8h.8a.77.77 0 0 0 .57-.23A.77.77 0 0 0 8 6v-.8a.77.77 0 0 0-.23-.57.77.77 0 0 0-.57-.23H5.6zm.8-3.2V6h.8v-.8zm2.4 3.2h1.6a.77.77 0 0 0 .57-.23.77.77 0 0 0 .23-.57V5.2a.77.77 0 0 0-.23-.57.77.77 0 0 0-.57-.23H8.8zm.8-3.2v2.4h.8V5.2z" clipRule="evenodd"/><path fill="currentColor" fillRule="evenodd" d="M3.67 12.33q.47.47 1.13.47h9.6q.66 0 1.13-.47T16 11.2V1.6q0-.66-.47-1.13A1.54 1.54 0 0 0 14.4 0H4.8q-.66 0-1.13.47A1.54 1.54 0 0 0 3.2 1.6v9.6q0 .66.47 1.13M14.4 11.2H4.8V1.6h9.6zM.47 15.53Q.94 16 1.6 16h11.2v-1.6H1.6V3.2H0v11.2q0 .66.47 1.13" clipRule="evenodd"/><path fill="#0076D8" d="M12 8.4h.8V6.8h.8V6h-.8v-.8h.8v-.8H12z"/></> }
    }
};

...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="#E12121" fillRule="evenodd" d="m1 21.5 11-19 11 19zm18.55-2L12 6.5l-7.55 13z" clipRule="evenodd"/><path fill="#E12121" d="M11 15.5h2v-5h-2zm1 3q.424 0 .713-.288A.97.97 0 0 0 13 17.5a.97.97 0 0 0-.287-.712A.97.97 0 0 0 12 16.5a.97.97 0 0 0-.713.288.97.97 0 0 0-.287.712q0 .424.287.712.288.288.713.288"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="#E12121" fillRule="evenodd" d="M0 14.818 8 1l8 13.818zm13.49-1.454L8 3.909l-5.49 9.455z" clipRule="evenodd"/><path fill="#E12121" d="M7.273 10.455h1.454V6.817H7.273zM8 12.636q.31 0 .518-.209.21-.21.21-.518a.7.7 0 0 0-.21-.518.7.7 0 0 0-.518-.21.7.7 0 0 0-.518.21.7.7 0 0 0-.21.518q0 .31.21.518.21.21.518.21"/></> }
    }
};

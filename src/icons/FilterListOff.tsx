...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="m13.86 11.022 2.017 2.018h2.195v-2.018zM8.816 5.978l2.017 2.018h10.265V5.978z" clipRule="evenodd"/><path fill="currentColor" d="M2.737 2.75 1.3 4.188l1.79 1.79 2.018 2.018 3.027 3.026 2.017 2.018 3.027 3.027.857.857 5.826 5.826 1.438-1.438z"/><path fill="currentColor" d="M10 16.067v2.017h4.036v-1.16l-.857-.857zm-4.034-5.045v2.018h4.186l-2.017-2.018zM2.94 5.978v2.018h2.168L3.09 5.978z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="m10.048 6.618 1.614 1.614h1.755V6.618zM6.013 2.583l1.614 1.614h8.212V2.583z" clipRule="evenodd"/><path fill="currentColor" d="M1.15 0 0 1.15l1.433 1.433 1.614 1.614 2.42 2.42 1.615 1.615 2.421 2.421.686.686L14.85 16 16 14.85z"/><path fill="currentColor" d="M6.96 10.653v1.614h3.23v-.928l-.687-.686zM3.733 6.618v1.614h3.349L5.468 6.618zM1.311 2.583v1.614h1.736L1.433 2.583z"/></> }
    }
};

...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M3.96 8.533V20h16.08V8.533L22 4.756 20.191 4l-2.362 4.489H6.171L3.809 4 2 4.756zm14.07 9.69H5.97v-7.956h12.06z" clipRule="evenodd"/><path fill="#007ADA" d="M9.99 13.778h4.02q.428 0 .716-.256a.81.81 0 0 0 .29-.633.81.81 0 0 0-.29-.633A1.04 1.04 0 0 0 14.01 12H9.99q-.428 0-.716.256a.81.81 0 0 0-.29.633q0 .378.29.633.289.256.716.256"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="M1.568 4.778v9.555h12.864V4.778L16 1.63 14.553 1l-1.89 3.74H3.337L1.447 1 0 1.63zm11.256 8.074H3.176v-6.63h9.648z" clipRule="evenodd"/><path fill="#007ADA" d="M6.392 9.148h3.216a.8.8 0 0 0 .573-.213.7.7 0 0 0 .231-.528.7.7 0 0 0-.231-.527.8.8 0 0 0-.573-.213H6.392a.8.8 0 0 0-.573.213.7.7 0 0 0-.231.527q0 .315.231.528a.8.8 0 0 0 .573.213"/></> }
    }
};

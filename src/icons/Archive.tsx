...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" d="M5 8v11h14V8zm0 13q-.824 0-1.412-.587A1.93 1.93 0 0 1 3 19V6.525q0-.35.112-.675.113-.325.338-.6L4.7 3.725q.274-.35.688-.538Q5.8 3 6.25 3h11.5q.45 0 .863.188.412.187.687.537l1.25 1.525q.225.274.337.6t.113.675V19q0 .824-.587 1.413A1.93 1.93 0 0 1 19 21zm.4-15h13.2l-.85-1H6.25z"/><path fill="#0076D8" d="m16 14-4 4-4-4 1.4-1.4 1.6 1.6V10h2v4.2l1.6-1.6z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" d="M1.778 4.444v9.778h12.444V4.444zm0 11.556q-.734 0-1.256-.522A1.7 1.7 0 0 1 0 14.222V3.133q0-.31.1-.6Q.2 2.245.4 2L1.511.644q.245-.31.611-.477Q2.49 0 2.89 0h10.22q.4 0 .767.167.367.166.61.477L15.6 2q.2.244.3.533t.1.6v11.09q0 .733-.522 1.255a1.7 1.7 0 0 1-1.256.522zm.355-13.333h11.734l-.756-.89H2.89z"/><path fill="#0076D8" d="M11.556 9.778 8 13.334 4.445 9.778l1.244-1.244 1.422 1.422V6.223H8.89v3.733l1.422-1.422z"/></> }
    }
};

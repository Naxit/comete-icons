...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="var(--icon-information)" fillRule="evenodd" d="M7.417 9.5v8.333H9.09l-.007-1.666h1.667v1.666h5.833V12h-4.166V9.5z" clipRule="evenodd"/><path fill="currentColor" fillRule="evenodd" d="M3.667 19.5q-.688 0-1.177-.49A1.6 1.6 0 0 1 2 17.833V6.167q0-.688.49-1.177.489-.49 1.177-.49h16.666q.688 0 1.177.49.49.489.49 1.177v11.666q0 .688-.49 1.177-.489.49-1.177.49zM20.333 6.167v11.666H3.667V6.167z" clipRule="evenodd"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="var(--icon-information)" fillRule="evenodd" d="M4.333 6v6.667h1.339l-.005-1.334H7v1.334h4.667V8H8.333V6z" clipRule="evenodd"/><path fill="currentColor" fillRule="evenodd" d="M1.333 14q-.55 0-.941-.392A1.28 1.28 0 0 1 0 12.667V3.333q0-.55.392-.941Q.783 2 1.333 2h13.334q.55 0 .941.392.392.391.392.941v9.334q0 .55-.392.941a1.28 1.28 0 0 1-.941.392zM14.667 3.333v9.334H1.333V3.333z" clipRule="evenodd"/></> }
    }
};

...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="#007ADA" d="M2 20 12 4l10 16zm3.6-2h12.8L12 7.75z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="#007ADA" d="M0 13.8 8 1l8 12.8zm2.88-1.6h10.24L8 4z"/></> }
    }
};

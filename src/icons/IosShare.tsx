...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M5.935 19.52q.48.48 1.156.48h9.818q.675 0 1.156-.48.48-.481.48-1.156v-9q0-.675-.48-1.156t-1.156-.48h-2.454v1.636h2.454v9H7.091v-9h2.455V7.727H7.09q-.675 0-1.156.481-.48.48-.48 1.156v9q0 .675.48 1.155" clipRule="evenodd"/><path fill="currentColor" d="M11.182 14.273V5.13l-1.31 1.309-1.145-1.166L12 2l3.273 3.273-1.146 1.166-1.309-1.31v9.144z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="M2.427 15.573A1.4 1.4 0 0 0 3.455 16h8.727a1.4 1.4 0 0 0 1.027-.427 1.4 1.4 0 0 0 .427-1.027v-8a1.4 1.4 0 0 0-.427-1.028 1.4 1.4 0 0 0-1.027-.427H10v1.454h2.182v8H3.455v-8h2.181V5.091H3.455a1.4 1.4 0 0 0-1.028.427A1.4 1.4 0 0 0 2 6.545v8q0 .6.427 1.028" clipRule="evenodd"/><path fill="currentColor" d="M7.09 10.91V2.781L5.928 3.945 4.91 2.91 7.82 0l2.908 2.91L9.71 3.944 8.545 2.782v8.127z"/></> }
    }
};

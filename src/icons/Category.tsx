...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M11.5 2 6 11h11zm-9 11.5v8h8v-8zm6 6h-4v-4h4zm3-13.65L13.45 9h-3.9zM17 22q-1.875 0-3.187-1.312Q12.5 19.375 12.5 17.5t1.313-3.187T17 13t3.188 1.313T21.5 17.5t-1.312 3.188T17 22m1.775-2.725Q18.05 20 17 20t-1.775-.725T14.5 17.5t.725-1.775T17 15t1.775.725.725 1.775-.725 1.775" clipRule="evenodd"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><g fill="currentColor" fillRule="evenodd" clip-path="url(#clip0_620_3054)" clipRule="evenodd"><path d="M7.5 0 3.25 7h8.5zm-7 9.5v6h6v-6zM5 14H2v-3h3zM7.5 2.896 9.083 5.5H5.917zM12 16q-1.458 0-2.48-1.02Q8.5 13.957 8.5 12.5t1.02-2.48Q10.543 9 12 9t2.48 1.02q1.02 1.022 1.02 2.48t-1.02 2.48Q13.457 16 12 16m1.417-2.078a1.94 1.94 0 0 1-1.422.578 1.92 1.92 0 0 1-1.416-.583A1.94 1.94 0 0 1 10 12.495q0-.837.583-1.416a1.94 1.94 0 0 1 1.422-.579q.837 0 1.416.583.579.584.579 1.422a1.92 1.92 0 0 1-.583 1.416"/></g><defs><clipPath id="clip0_620_3054"><path fill="currentColor" d="M0 0h16v16H0z"/></clipPath></defs></> }
    }
};

...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M2.653 21.347a2.14 2.14 0 0 0 1.57.653h15.555a2.14 2.14 0 0 0 1.57-.653 2.14 2.14 0 0 0 .652-1.57V4.223a2.14 2.14 0 0 0-.653-1.57A2.14 2.14 0 0 0 19.777 2H4.223a2.14 2.14 0 0 0-1.57.653A2.14 2.14 0 0 0 2 4.223v15.555q0 .916.653 1.57m17.125-1.57H4.222V4.223h15.556z" clipRule="evenodd"/><path fill="#0076D8" d="M5.333 17.556h13.334L14.5 12l-3.333 4.444-2.5-3.333z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="M.522 15.478Q1.044 16 1.778 16h12.444q.734 0 1.256-.522T16 14.222V1.778q0-.734-.522-1.256A1.7 1.7 0 0 0 14.222 0H1.778Q1.044 0 .522.522A1.7 1.7 0 0 0 0 1.778v12.444q0 .734.522 1.256m13.7-1.256H1.778V1.778h12.444z" clipRule="evenodd"/><path fill="#0076D8" d="M2.667 12.444h10.666L10 8l-2.667 3.556-2-2.667z"/></> }
    }
};

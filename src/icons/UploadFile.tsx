...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M5.855 21.413Q6.442 22 7.267 22h12q.824 0 1.413-.587.587-.588.587-1.413V8l-6-6h-8q-.824 0-1.412.588A1.93 1.93 0 0 0 5.267 4v16q0 .825.588 1.413M14.267 4v5h5v11h-12V4z" clipRule="evenodd"/><path fill="var(--icon-information)" d="M12.267 19h2v-4.174l1.6 1.6 1.4-1.425-4-4-4 4 1.425 1.4 1.575-1.575z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="M2.44 15.06q.442.44 1.06.44h9q.619 0 1.06-.44.44-.442.44-1.06V5L9.5.5h-6q-.62 0-1.06.44Q2 1.382 2 2v12q0 .619.44 1.06M8.75 2v3.75h3.75V14h-9V2z" clipRule="evenodd"/><path fill="var(--icon-information)" d="M7.25 13.25h1.5v-3.131l1.2 1.2L11 10.25l-3-3-3 3 1.069 1.05 1.181-1.181z"/></> }
    }
};

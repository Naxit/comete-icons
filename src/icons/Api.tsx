...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="m7.72 5.614 2.015 2.015 1.932-1.932 1.932 1.932 2.015-2.015-3.947-3.947zm-6.053 6.053 3.947 3.947 2.015-2.015-1.932-1.932 1.932-1.932L5.614 7.72zm14.038 1.932 2.015 2.015 3.947-3.947L17.72 7.72l-2.015 2.015 1.932 1.932zm-7.985 4.12 3.947 3.948 3.947-3.947-2.015-2.015-1.932 1.932-1.932-1.932z" clipRule="evenodd"/><path fill="#0076D8" d="M11.667 13.864 9.47 11.667l2.197-2.197 2.197 2.197z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="m5.04 3.46 1.51 1.512L8 3.522l1.449 1.45L10.96 3.46 8 .5zM.5 8l2.96 2.96 1.512-1.51L3.522 8l1.45-1.449L3.46 5.04zm10.529 1.449 1.51 1.511L15.5 8l-2.96-2.96-1.511 1.511L12.477 8zm-5.99 3.09L8 15.5l2.96-2.96-1.511-1.511L8 12.477l-1.449-1.449z" clipRule="evenodd"/><path fill="#0076D8" d="M8 9.648 6.352 8 8 6.352 9.648 8z"/></> }
    }
};

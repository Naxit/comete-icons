...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M1.575 12.325 12 18l10.425-5.675-2.1-1.15L12 15.725l-8.325-4.55zm0 4L12 22l10.425-5.675-2.1-1.15L12 19.725l-8.325-4.55z" clipRule="evenodd"/><path fill="currentColor" fillRule="evenodd" d="M12 14 1 8l11-6 11 6zm6.825-6L12 11.725 5.175 8 12 4.275z" clipRule="evenodd"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" fillRule="evenodd" d="M.418 8.21 8 12.336l7.582-4.128-1.527-.836L8 10.682l-6.055-3.31zm0 2.908L8 15.246l7.582-4.128-1.527-.836L8 13.592l-6.055-3.31z" clipRule="evenodd"/><path fill="currentColor" fillRule="evenodd" d="M8 9.427 0 5.064 8 .7l8 4.364zm4.964-4.363L8 7.773l-4.964-2.71L8 2.356z" clipRule="evenodd"/></> }
    }
};

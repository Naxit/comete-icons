...
const svgData: Record<string, Record<string, { viewBox: string; paths: React.JSX.Element }>> = {
    ...
    duotone: {
      "default": { viewBox: "0 0 24 24", paths: <><path fill="currentColor" fillRule="evenodd" d="M8 17.556V16H6.5l2.167-2.889 2.5 3.333L14.5 12l4.167 5.556z" clipRule="evenodd"/><path fill="currentColor" d="M2.653 2.653A2.14 2.14 0 0 0 2 4.223V16h2.222V4.222h15.556v15.556H8V22h11.778a2.14 2.14 0 0 0 1.57-.653 2.14 2.14 0 0 0 .652-1.57V4.223a2.14 2.14 0 0 0-.653-1.57A2.14 2.14 0 0 0 19.777 2H4.223a2.14 2.14 0 0 0-1.57.653"/><path fill="var(--icon-information)" d="M7.01 18.124 5.904 17l-2.327 2.327v-1.755H2v4.457h4.457V20.45H4.682z"/></> },
      "none": { viewBox: "0 0 16 16", paths: <><path fill="currentColor" d="M.522.522A1.7 1.7 0 0 0 0 1.778v8h1.778v-8h12.444v12.444h-8V16h8q.734 0 1.256-.522T16 14.222V1.778q0-.734-.522-1.256A1.7 1.7 0 0 0 14.222 0H1.778Q1.044 0 .522.522"/><path fill="currentColor" d="M13.333 12.444 10 8l-2.667 3.556-1.11-1.482v2.37zm-8-3.555-.666.889H6z"/><path fill="var(--icon-information)" d="m4.453 12.333-.982-1-2.069 2.069v-1.56H0v3.961h3.962v-1.402H2.384z"/></> }
    }
};
